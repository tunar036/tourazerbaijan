                    ...
                    <div class="tour-list-details wow fadeIn">
                        ...
                        <div class="tour-body">
                            <div class="tour-content">
                                ...
                                <span
                                    class="tour-place">{{ $tour->address->getTranslatedAttribute('name', App::getLocale(), 'az') }}</span>
                            </div>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flush-headingOne">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="flush-collapseOne"> How to book the new tour for 2 persons? </button>
                            </h2>
                            <div id="flush-collapseOne" class="accordion-collapse collapse"
                                aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                <div>
                                    <p class="faq-text"> Lorem Ipsum available, but the majority have suffered alteration in
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flush-headingTwo">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="flush-collapseTwo"> Why are your tours so expensive? </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            <h2 class="accordion-header" id="flush-headingThree">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="flush-collapseThree"> Which payment methods are acceptable? </button>
                            </h2>
